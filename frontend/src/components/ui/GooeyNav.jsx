...
const GooeyNav = ({
  ...
  // This existing effect will now be triggered correctly by the state change
  useEffect(() => {
      ...
      <style>
        {`
            ...
            .gooey-nav-container {
                --theme-brown: #5B3E31;
                --theme-amber: #FFCA28;
                --color-1: var(--theme-brown);
                --color-2: var(--theme-amber);
                --color-3: #ffffff;
                --color-4: #A9A9A9;
            }
                --active-bar-bg: #ffffff; /* Default (light mode) white */
            }
                .dark .gooey-nav-container {
            --active-bar-bg: #4A4A4A; /* Dark mode gray */
            }
            :root {
